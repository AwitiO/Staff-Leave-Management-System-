...
<title>Approved Leave For <?php echo $detail['f_name']; ?>  <?php echo $detail['l_name']; ?> </title>
...
<div class="row mb-2">
<div class="col-sm-6">
<h1 class="m-0">Approved Leave Dashboard</h1>
</div><!-- /.col -->
<div class="col-sm-6">
...
<h3 class="card-title">Approved Leave of <?php echo $detail['f_name']; ?>  <?php echo $detail['l_name']; ?> </h3>
</div>
<!-- /.card-header -->
<div class="card-body">
...
$sql = "SELECT * FROM leave_details WHERE l_status='2' AND staff_no='$staff'";
