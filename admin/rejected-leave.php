...
<h3 class="card-title">Rejected Leave</h3>
</div>
<!-- /.card-header -->
<div class="card-body">
...
<tbody>
<?php
$sql = "SELECT * FROM leave_details INNER JOIN staff_details ON staff_details.staff_no=leave_details.staff_no  WHERE l_status=0";
...
<td><?php echo $value['end_date']?></td>
 <td> <form role="form" action="" method="post">
  ...
  <center><a href = "dismiss_approval.php?id=<?php echo $value ['id']?>" class = "btn btn-success "> Unreject</a><br></br></center>
  </div>
  </div>
  </div>
  </div> 
